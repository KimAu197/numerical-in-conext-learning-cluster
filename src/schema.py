...
# curriculum_schema_train = {
#     "n_dims": stdict(curriculum_base_schema), # number of dimensions
# }
...
model_schema = {
    ...
    # "curriculum": stdict(curriculum_schema_train),
    "n_embd": merge(tinteger, required),
    "n_layer": merge(tinteger, required),
    "n_head": merge(tinteger, required),
    "n_cluster": merge(tinteger,  default(2)),
}
...
training_schema = {
    ...
    "n_cluster": merge(tinteger, nullable, default(None)), # 添加 n_cluster 字段
    "save_sample": merge(tboolean, nullable, default(False)), # 是否保存一部分训练数据sampler
...
schema = {
    ...
    # "set_device": merge(tstring, default("cuda:0")),
}